...
class RAGConfig(BaseSettings):
    ...
    max_retries: int = Field(default=2, gt=0, description="Maximum number of retries")
    max_retrieval_depth: int = Field(default=3, gt=0, lt=10, description="Maximum retrieval depth")
